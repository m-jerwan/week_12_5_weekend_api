...
ForcesList.prototype.getForcesList = function () {
    return this.forcesList;
}

ForcesList.prototype.getForcesIds = function () {
    const forcesOnlyIds = [];
    this.forcesList.forEach(force => {
        forcesOnlyIds.push(force.id);
    });
    return forcesOnlyIds;
}
